...
public class FormMain extends JFrame {
	...
	public FormMain() {
		...
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5)); // tạo border thuộc tính ngoài
		setContentPane(contentPane);
		contentPane.setLayout(null);
		
		lbTitle = new JLabel("ALGORITHM SIMULATION");
		...
		pnAlgorithm.setBorder(new TitledBorder(null, "Menu Algorithm", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		pnControl = new JPanel();
		pnControl.setBackground(SystemColor.menu);
		pnControl.setBorder(new TitledBorder(null, "Controllers", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		rdDecrease = new JRadioButton("Sort Decrease");
		...
		pnCreateArray.setBorder(new TitledBorder(null, "Create Arrays", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		pnSetValueArray = new JPanel();
		pnSetValueArray.setBackground(SystemColor.menu);
		pnSetValueArray.setBorder(new TitledBorder(null, "Create Data Arrays", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnByHand = new JButton("By Hands");
		...
		btnOpenFile = new JButton("Open files");
		...
		btnReadFile = new JButton("Close files");
		...
		lbNum = new JLabel("Number Element Array\r\n:");
		...
		btnCreateArray = new JButton("Create Arrays");
		...
		btnDeleteArray = new JButton("Export Arrays");
		...
		lbMaxNum = new JLabel("(Not Max&Min)");
		...
		pnImitiate.setBorder(new TitledBorder(null, "Simulation Running Frame", TitledBorder.LEADING, TitledBorder.TOP, null, null));
