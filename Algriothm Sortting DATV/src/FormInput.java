...
public class FormInput extends JFrame {
	 ...
	 */
	public FormInput() {
		setTitle("Enter Data Into The Arrays");
		...
		JLabel lblNewLabel = new JLabel("Number Selement Arrays");
		...
		JButton btnCreateArray = new JButton("Create Arrays");
	...
	public void beAccepted() {
		...
		if (num != 0) {
			JOptionPane.showMessageDialog(this, "Successfully Created Array Data!\nReady To Exit!");
			this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
		}
		else {
			JOptionPane.showMessageDialog(this, "Not Yet Created Array Data!\nReady To Exit!");
			this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
		}
